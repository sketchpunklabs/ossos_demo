...
const prepend = ( document.location.hostname.indexOf( 'localhost' ) === -1 )? '/ossos_demo' : '';

document.body.appendChild(Object.assign(document.createElement('script'), {
type		: 'importmap',
innerHTML	: `
    {"imports":{
        "@three"             : "${prepend}/_thirdparty/three.module.js",
        "@OrbitControls"	 : "${prepend}/_thirdparty/OrbitControls.js",
        "@ossos"	         : "${prepend}/_lib/ossos.js",
        "@Gltf2"	         : "${prepend}/_lib/gltf2parser.js",
        "@lib/"              : "${prepend}/_lib/"
    }}
`}));
